...
namespace Aspose.GIS.Live.Demos.UI.Config
{
	...
	/// </summary>
	public class AsposeGISContext : Context
	{
		/// <summary>
		...
		/// </summary>
		/// <param name="hc"></param>
		internal AsposeGISContext(HttpContext hc) : base(hc) { Thread.SetData(Thread.GetNamedDataSlot(Configuration.ResourceFileSessionName + "ContextSlot"), hc); }
		private static AsposeGISContext atc;
		/// <summary>
		///  Use for internal syncing of the context
		/// </summary>
		internal static AsposeGISContext atcc { set { atc = value; } }
		internal static AsposeGISContext Current
		{
			get { return atc; }
		}
